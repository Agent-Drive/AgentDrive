...
from agentdrive.engine.search.vector import SearchResult
...
@pytest.mark.asyncio
@patch("agentdrive.engine.search.engine.rerank_results")
@patch("agentdrive.engine.search.engine.bm25_search", new_callable=AsyncMock)
@patch("agentdrive.engine.search.engine.vector_search", new_callable=AsyncMock)
@patch("agentdrive.engine.search.engine.EmbeddingClient")
