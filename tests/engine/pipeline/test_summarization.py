...
from agentdrive.engine.pipeline.ingest import (
    _batch_parents,
...
@pytest.mark.asyncio
@patch("agentdrive.engine.pipeline.ingest._hierarchical_summarize", new_callable=AsyncMock)
@patch("agentdrive.engine.pipeline.ingest.generate_document_summary", new_callable=AsyncMock)
...
@pytest.mark.asyncio
@patch("agentdrive.engine.pipeline.ingest.generate_reduce_summary", new_callable=AsyncMock)
@patch("agentdrive.engine.pipeline.ingest.generate_group_summary", new_callable=AsyncMock)
