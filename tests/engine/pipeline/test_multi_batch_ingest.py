...
from agentdrive.engine.pipeline.chunking.base import ChunkResult, ParentChildChunks
...
from agentdrive.engine.data.models.types import BatchStatus, FileStatus
...
@pytest.mark.asyncio
@patch("agentdrive.engine.pipeline.ingest.generate_table_aliases", new_callable=AsyncMock)
@patch("agentdrive.engine.pipeline.ingest.enrich_chunks_with_summaries", new_callable=AsyncMock)
@patch("agentdrive.engine.pipeline.ingest.generate_document_summary", new_callable=AsyncMock)
@patch("agentdrive.engine.pipeline.ingest.embed_file_aliases", new_callable=AsyncMock)
@patch("agentdrive.engine.pipeline.ingest.embed_file_chunks", new_callable=AsyncMock)
@patch("agentdrive.engine.pipeline.ingest.StorageService")
@patch("agentdrive.engine.pipeline.ingest.registry")
