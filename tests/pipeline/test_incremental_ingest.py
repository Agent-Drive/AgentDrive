...
from agentdrive.pipeline.chunking.base import ChunkResult, ParentChildChunks
...
from agentdrive.data.models.types import BatchStatus, FileStatus
from agentdrive.pipeline.ingest import process_file
...
@pytest.mark.asyncio
@patch("agentdrive.pipeline.ingest.generate_table_aliases", new_callable=AsyncMock)
@patch("agentdrive.pipeline.ingest.enrich_chunks_with_summaries", new_callable=AsyncMock)
@patch("agentdrive.pipeline.ingest.generate_document_summary", new_callable=AsyncMock)
@patch("agentdrive.pipeline.ingest.embed_file_aliases", new_callable=AsyncMock)
@patch("agentdrive.pipeline.ingest.embed_file_chunks", new_callable=AsyncMock)
@patch("agentdrive.pipeline.ingest.StorageService")
@patch("agentdrive.pipeline.ingest.registry")
