...
from agentdrive.pipeline.enrichment.table_questions import is_table_chunk, generate_table_aliases
...
@pytest.mark.asyncio
@patch("agentdrive.pipeline.enrichment.table_questions.EnrichmentClient")
