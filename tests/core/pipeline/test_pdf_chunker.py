...
class TestDocAiToMarkdown:
    def test_paragraph(self):
        from agentdrive.core.pipeline.chunking.pdf import _doc_ai_to_markdown
...
class TestPdfChunker:
    @patch("agentdrive.core.pipeline.chunking.pdf.PdfReader")
    @patch("agentdrive.core.pipeline.chunking.pdf.documentai")
    @patch("agentdrive.core.pipeline.chunking.pdf.settings")
    ...
    @patch("agentdrive.core.pipeline.chunking.pdf.PdfWriter")
    @patch("agentdrive.core.pipeline.chunking.pdf.PdfReader")
    @patch("agentdrive.core.pipeline.chunking.pdf.documentai")
    @patch("agentdrive.core.pipeline.chunking.pdf.settings")
