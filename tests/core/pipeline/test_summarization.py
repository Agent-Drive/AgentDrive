...
from agentdrive.core.pipeline.ingest import (
    _batch_parents,
...
@pytest.mark.asyncio
@patch("agentdrive.core.pipeline.ingest._hierarchical_summarize", new_callable=AsyncMock)
@patch("agentdrive.core.pipeline.ingest.generate_document_summary", new_callable=AsyncMock)
...
@pytest.mark.asyncio
@patch("agentdrive.core.pipeline.ingest.generate_reduce_summary", new_callable=AsyncMock)
@patch("agentdrive.core.pipeline.ingest.generate_group_summary", new_callable=AsyncMock)
