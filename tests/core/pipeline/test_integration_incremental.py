...
from agentdrive.core.pipeline.chunking.base import ChunkResult, ParentChildChunks
...
from agentdrive.core.data.models.types import BatchStatus, FileStatus
...
@pytest.mark.asyncio
@patch("agentdrive.core.pipeline.ingest.generate_table_aliases", new_callable=AsyncMock)
@patch("agentdrive.core.pipeline.ingest.enrich_chunks_with_summaries", new_callable=AsyncMock)
@patch("agentdrive.core.pipeline.ingest.generate_document_summary", new_callable=AsyncMock)
@patch("agentdrive.core.pipeline.ingest.embed_file_aliases", new_callable=AsyncMock)
@patch("agentdrive.core.pipeline.ingest.embed_file_chunks", new_callable=AsyncMock)
@patch("agentdrive.core.pipeline.ingest.StorageService")
@patch("agentdrive.core.pipeline.ingest.registry")
