...
from agentdrive.core.data.models.types import BatchStatus
from agentdrive.core.pipeline.embedding.pipeline import embed_file_chunks
...
async def test_embed_with_batch_id_scopes_to_batch(db_session):
    ...
    with patch("agentdrive.core.pipeline.embedding.pipeline.EmbeddingClient") as MockClient:
