...
from agentdrive.core.search.vector import SearchResult
...
@pytest.mark.asyncio
@patch("agentdrive.core.search.engine.rerank_results")
@patch("agentdrive.core.search.engine.bm25_search", new_callable=AsyncMock)
@patch("agentdrive.core.search.engine.vector_search", new_callable=AsyncMock)
@patch("agentdrive.core.search.engine.EmbeddingClient")
